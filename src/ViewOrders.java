...
import com.mysql.cj.otel.OpenTelemetrySpan;
...
public class ViewOrders extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(22, 94, 374, -1));
        ...
        getContentPane().add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 94, 374, -1));
        ...
        getContentPane().add(btnClose, new org.netbeans.lib.awtextra.AbsoluteConstraints(752, 550, -1, -1));

        jLabel2.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        jLabel2.setText("Customer List");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 66, -1, -1));

        jLabel3.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        jLabel3.setText("Order List");
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(607, 66, -1, -1));
    ...
    private void customerTabMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_customerTabMouseClicked
        ...
        DefaultTableModel ordermodel = (DefaultTableModel) orderTab.getModel();
    ...
    private void orderTabMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_orderTabMouseClicked
        // TODO add your handling code here:
        int index = orderTab.getSelectedRow();
        TableModel model = orderTab.getModel();
